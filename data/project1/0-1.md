...
**KH:** [00:02.000] 今回開発を予定している新システムについて、要件の全体像とビジネス背景をご共有いたしたく、本日お時間をいただきました。
...
**BrSE:** [00:12.608] 承知いたしました。本日は系統的な要件ヒアリングをさせていただきたいと思っております。まずは背景と目的について、階層的に詳細をお聞きしたいのですが、よろしいでしょうか。
...
- 背景（はいけい）| bối cảnh  
- 目的（もくてき）| mục tiêu  
- 系統的な（けいとうてきな）| có hệ thống  
- 階層的（かいそうてき）| theo tầng, theo cấp bậc  
- 対象範囲（たいしょうはんい）| phạm vi đối tượng  
- 連携（れんけい）| liên kết, tích hợp  
- 想定（そうてい）| giả định, dự kiến  
- 工数見積り（こうすうみつもり）| estimate effort  
- 整理（せいり）| sắp xếp, chỉnh lý lại  
- 後日（ごじつ）| hôm khác, sau này  
- 提示（ていじ）| trình bày, đưa ra  
